...
public class TestPerson1 {
  ...
  public static void main(String[] args){
    ...
    Person child = new person("Kwabena", 12, "Male");

    Person infant = new person("Abena", 1, "Female");

    Person  toddler= new person("Kwabena", 2, "Male");

    Person youth= new person("Afua", 23, "Female");

    Person teenager= new person("Kwabena", 16, "Male");
